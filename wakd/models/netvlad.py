...
class EmbedRegionNet(nn.Module):
    ...
    def _compute_region_sim_triple(self, feature_A, feature_B):
        ...
        vlad_A = torch.cat((vlad_A_global, vlad_A_triple), dim=1)
        vlad_B = torch.cat((vlad_B_global, vlad_B_triple), dim=1)
        vlad_A = norm(vlad_A)
        vlad_B = norm(vlad_B)
    ...
    def _forward_train(self, x):
        ...
        return self._compute_region_sim_triple(anchors, pairs)
