...
from wakd.utils.data.sampler import SubsetRandomSampler
...
def get_model(args):
    ...
    # base_model = models.create(args.arch, pretrained=True, cut_at_pooling=True, matconvnet='logs/vd16_offtheshelf_conv5_3_max.pth')
    # base_model = models.create(args.arch, model_path='logs/resnet152-b121ed2d.pth')
